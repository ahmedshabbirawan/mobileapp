...
<div class="page-header" style="min-height:40px;">
    ...
    <div class="" style="float: right;">
        <a href="{{ route('term.logo_category.create') }}" class="btn btn-xs btn-light bigger"><i class="ace-icon fa fa-floppy-o"></i> Add Record </a> 
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        table = $('#yajra-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('term.logo_category.list') }}",
            columns: [
                {
                    data: 'id',
                    name: 'id',
