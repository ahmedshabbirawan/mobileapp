...
$actionURL =  route('term.logo_category.store');
...
if (isset($product)) {
    ...
    $actionURL =  route('term.logo_category.update', $product->id);
...
<div class="row ">
    <div class="col-12 col-lg-12" style="margin-top:20px; width:100%">
        ...
        <div class="card radius-10 border-top border-0 border-4 border-danger">
            ...
            <form method="post" id="product_form" action="{{ isset($product) ? route('term.logo_category.update', $product->id) : route('term.logo_category.store') }}" novalidate class="form-horizontal product_form">
                @csrf
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-body" style="display: block;">
                                ...
                                <div class="widget-main">
                                    ...
                                    <div style="display: none;" class="col-lg-4 col-sm-4">
