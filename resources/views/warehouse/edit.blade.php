...
<form method="post" action="{{ route('Settings.warehouse.update',$row->id) }}" novalidate class="form-horizontal">
                        ...
                        <div class="widget-body" style="display: block;">
                            <div class="widget-main">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="col-xs-10 col-sm-5 form-control @error('code') is-invalid @enderror" value="{{ (old('code'))?old('code'):$row->code }}" name="code" id="code" placeholder="code">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                    <textarea class="form-control  @error('address') is-invalid @enderror" name="address" id="address" placeholder="Address">{{old('address',$row->address )}}</textarea>
