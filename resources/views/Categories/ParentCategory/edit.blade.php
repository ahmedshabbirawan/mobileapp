...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal" method="POST" action="{{route('category.parent.update',['id'=>$obj->id])}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <label><b>Enter Category Name</b></label><br>
                                <input type="text" name="name" placeholder="Category Name" value="{{$obj->name}}" class="form-control" style="margin-top: 10px;" required />
                            </div>
                        </div>
