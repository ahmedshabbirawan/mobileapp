                                        ...
                                        <div class="col-xs-12">
                                            <table id="subview-table" class="table  table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="tr_{{$index}}">
                                                        <td class=""><select name="type[]" onchange="selectType(this);"  job_index="<?=$index?>"  >
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="col-lg-6 col-sm-6">
                                                                <label for="file-upload" class="custom-file-upload btn-xs btn-info image_input" style="text-align: center;">Change</label>
                                                                <input name="subview_image_file[]" id="file-upload_`+subviewIndex+`" class="subview_file_input image_input" type="file" onchange="imageFileChange(this);" />
                                                            </div>
...
<script>
    ...
    function addNewRow() {
        ...
        <td class=""><select name="type[]" onchange="selectType(this);" job_index="` + subviewIndex + `" ><option value="Image" ` + imageView + ` >Image</option><option value="Label" ` + labelView + ` >Label</option></select></td>
    ...
    function saveSubView(action, index) {
        ...
        <td class=""><select name="type[]" style="pointer-events: none;" job_index="` + index + `" ><option value="Image" ` + imageView + ` >Image</option><option value="Label" ` + labelView + ` >Label</option></select></td>
