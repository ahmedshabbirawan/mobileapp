                    ...
                    <form class="form-horizontal" method="POST" action="{{route('usermanagement.user.store')}}">
                        ...
                        <div class="row">
                            <div class="col-md-3" style="margin-top: 10px;">
                                ...
                                <input type="text" name="name" placeholder=" Person Name" class="form-control" required />
                            </div>
                            <div class="col-md-3" style="margin-top: 10px;">
                            ...
                            <div class="col-md-3" style="margin-top: 10px;">
                                ...
                                <input type="text" name="username" placeholder="Please Provide Username" class="form-control" required />
                            </div>
                            <div class="col-md-3" style="margin-top: 10px;">
